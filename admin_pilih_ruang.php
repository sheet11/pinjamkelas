    ...
    <div class="col-md-6 form">
      <form method="post" action="admin_proses_pilih_ruang.php">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" placeholder="Masukkan Mata Kuliah" value="<?php echo $matkul; ?>" name="matkul" required autocomplete="off">
        </div>
        ...
        <div class="form-group">
          ...
          <?php
          $data_ruang = mysqli_query($koneksi, "SELECT * FROM ruangan ORDER by nama_ruang ASC");
          while ($ruang = mysqli_fetch_array($data_ruang)) { ?>
            <input type="radio" name="ruang" value="<?= $ruang['nama_ruang']; ?>">
            <label for="<?= $ruang['nama_ruang']; ?>"><?= $ruang['nama_ruang']; ?> => <?php print ($ruang['status_pinjam'] == 'Tersedia') ? "<span class='badge hijau'>Tersedia</span>" : '<span class="badge merah">Sedang di pinjam</span>';  ?></label><br>
          <?php } ?>
        </div>
        ...
        <!-- <div class="form-group">
          ...
          <select name="ruang" class="form-control">
            ...
            while ($ruang = mysqli_fetch_array($data_ruang)) { ?>
              <option value="<?= $ruang['nama_ruang']; ?>"><?= $ruang['nama_ruang']; ?>, status = <?php print ($ruang['status_pinjam'] == 'Kosong') ? "<span style='text-color: red'>KosongSedang di pinjam</span>" : '<span class="badge hijau">Sedang di pinjam</span>';  ?></option>
            <?php } ?>
          </select>
        </div> -->
