    ...
    <div class="col-md-6 form">
      <form method="post" action="admin_prosespinjam.php">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" name="ruang" value="<?php echo $ruang; ?>">
        </div>
        ...
        <div class="form-group">
          ...
          <select name="ruang" class="form-control">
            ...
            while ($ruang = mysqli_fetch_array($data_ruang)) { ?>
              <option value="<?= $ruang['nama_ruang']; ?>"><?= $ruang['nama_ruang']; ?>, status = <?php print ($ruang['status_pinjam'] == 'Kosong') ? "<span style='text-color: red'>Kosong</span>" : '<span class="badge hijau">Sedang di pinjam</span>';  ?></option>
            <?php } ?>
          </select>
        </div>
