...
<html>
  <head>
    <meta charset="utf-8">
    <title>Login Mahasiswa | Poltekkes Kemenkes Bengkulu</title>
...
<div class="container-fluid">
  <div class="row content">
  	...
  	<div class="col-sm-6">
    	<form action="cek_login_mhs.php" method="post" autocomplete="off">
    		<div class="form-group">
      		...
      		<div class="form-group">
      		    ...
      		    <button type="submit" name="login" class="btn btnacc">LOGIN</button>
    	</form>
    </div>
    <div class="col-sm-3"></div>
  </div>
